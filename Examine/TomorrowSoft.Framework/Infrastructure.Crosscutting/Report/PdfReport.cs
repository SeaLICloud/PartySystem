...
namespace TomorrowSoft.Framework.Infrastructure.Crosscutting.Report
{
    ...
    {
        public PdfReport(string reportPath, ReportDataSource reportDataSource)
            : base(reportPath, reportDataSource)
        {
        }

        public PdfReport(string reportPath, ReportDataSource reportDataSource, ReportParameter[] myParameterList)
            : base(reportPath, reportDataSource, myParameterList)
        {
        }
